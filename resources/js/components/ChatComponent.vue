    ...
    <div class="flex flex-col h-[500px]">
      ...
      <div ref="messageContainer" class="overflow-y-auto p-4 mt-3 flex-grow border-t border-gray-200">
        <div class="space-y-4">
          ...
          >
            <div
              :class="message.sender_id === currentUser.id ? 'bg-gray-800 text-white' : 'bg-gray-200 text-gray-800'"
      ...
      <div class="border-t pt-4">
        <form @submit.prevent="sendMessage">
          <div class="flex items-center">
            ...
            />
            <button type="submit" class="ml-2 p-4 bg-blue-500 text-gray-100  rounded-lg shadow hover:bg-blue-600 transition duration-300 flex items-center justify-center">
